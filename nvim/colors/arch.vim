...
hi IncSearch ctermfg=0 ctermbg=5 cterm=NONE guifg=#000000 guibg=#e050e0 gui=NONE
hi Search ctermfg=231 ctermbg=236 cterm=NONE guifg=#000000 guibg=#090909 gui=NONE
hi Directory ctermfg=62 ctermbg=NONE cterm=NONE guifg=#5A5AE6 guibg=NONE gui=NONE
hi Folded ctermfg=5 ctermbg=0 cterm=NONE guifg=#2E2F31 guibg=#2E2F31 gui=NONE
